...
function custom_image_by_url($atts) {
    ...
    return '<img src="' . esc_url($atts['url']) . '" alt="" style="max-width: 100%; height: auto; border-radius: 8px;" />';
}

add_shortcode('custom_image', 'custom_image_by_url');
