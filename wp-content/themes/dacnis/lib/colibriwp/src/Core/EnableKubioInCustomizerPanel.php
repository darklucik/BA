...
class EnableKubioInCustomizerPanel extends \WP_Customize_Panel {
	...
	protected function render() {
		...
		$message = __( 'The Kubio plugin takes Dacnis to a whole new level by adding new and powerful editing and styling options. Wanna have full control over your design with Dacnis?', 'dacnis' );
